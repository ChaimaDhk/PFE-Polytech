...
/// </summary>
codeunit 50134 "Workflow Congé Setup Ext4"
{
    trigger OnRun()
    begin
    ...
    begin
        WorkflowSetup.InsertTableRelation(Database::NotesDeFrais, 0, Database::"Approval Entry", ApprovalEntry.FieldNo("Record ID to Approve"));
    end;
    ...
    var
        ...
        RequestWorkflowCategoryTxt: Label 'DVS';

        RequestWorkflowCategoryDescTxt: Label 'Demandes de Frais';

        RequestApprovalWorkflowCodeTxt: Label 'DC';

        RequestApprovalWorkfowDescTxt: Label 'Note de frais Approval Workflow';
